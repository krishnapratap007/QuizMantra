                                   ...
                                   <tr>
                                      <td>  
                                           ...
                                           <table cellspacing="10">
                                               ...
                                               <form method="post" action="adminteacherpanel.php" name="test">
                                        ...
                                        <form method="post" action="testsession.php">
                                           ...
                                           <table cellpadding='10'>
                                              ...
                                              <tr><td><label style="font-size: 25px;">Subject : <hr></td></tr>
                                                ...
                                                <tr><td style="padding-top:50%;"><label>Suffle Questions :</label><input type="checkbox" name="suffle" value="suffle" /></td></tr>
                                                ...
                                                <tr><td><a href="testhistory.php"><input type="button" value="TEST HISTORY" style="height: 30px; width: 200px; background-color: #C0FAE7"></a></td></tr>
                                                 <tr><td><a href="edittest.php"><input type="button" value="EDIT TEST" style="height: 30px; width: 200px; background-color: #C0FAE7"></a></td></tr>
