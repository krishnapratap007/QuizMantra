          ...
          ?>
             ...
             if (isset($_SESSION['tcname'])){
                       ...
                       if (isset($_REQUEST['add'])){
                            ?>
                                    <table cellpadding="20" cellspacing="15" style="text-align:left;padding-left: 10%;" >
                                        <tr>
                                            <td>Subject Name</td>
                                            <td>
                                                <select name="subject">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="help"><b>Note:</b><br/>Test Name must be Unique in order to <br/>identify different tests on same subject.</div></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="help"><b>Note:</b><br/>Candidates must enter this code<br/> in order to  take the test</div></td>
                                        </tr>
                                    ...
                                    <table cellpadding="20" cellspacing="15" style="text-align:left;padding-left: 10%;" >
                                         ...
                                         ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><div class="help"><b>Note:</b><br/>Test Name must be Unique in order to identify <br/>different tests on same subject.</div></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Test Description</td>
